\subsection{Meson correlation function}
    ...
    \subsubsection{Meson correlation functions}
        ...
        % TODO more about how to extract mass from energy
        ...
        \begin{equation}
            ...
            \end{aligned}
        \end{equation}
        where $\langle...\rangle_F$ describes the fermionic expectation value. Therefore only the path integral over the gauge field remains and equation \mref{correlation_in_t} becomes:
